        ...
        const newComment = `
            <li class="list-group-item" id="comment-${data.id}">
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <div class="ms-auto">
                        <!-- Показываем кнопки редактирования/удаления только если пользователь авторизован и является автором -->
                        ${data.is_authenticated && data.is_author ? `
                        ...
                        ` : ''}
                        <!-- Кнопка для жалобы на комментарий доступна для всех пользователей -->
                        ${data.is_authenticated && !data.is_author ? `
